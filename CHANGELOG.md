...
### Fixed
- PTY probes: hard-stop live command trees through the bounded process-group path, keeping idle and deadline cleanup under three seconds even when system-wide descriptor scans are slow.
